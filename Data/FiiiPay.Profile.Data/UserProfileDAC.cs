...
namespace FiiiPay.Profile.Data
{
    public class UserProfileDAC : BaseDataAccess
    {
        ...
        {
            string SQL = "INSERT INTO UserProfiles(UserAccountId, LastName,FirstName,IdentityDocNo,IdentityDocType,Postcode,Country) " +
                         "VALUES(@UserAccountId, @LastName,@FirstName,@IdentityDocNo,@IdentityDocType,@Postcode,@Country)";
